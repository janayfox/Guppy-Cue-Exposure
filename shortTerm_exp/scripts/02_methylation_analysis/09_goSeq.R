...
#DMS_TSS_all_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_all/DMS_TSS_all_hyper.RDS")
DMS_TSS_05h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_05h/DMS_TSS_05h_hyper.RDS")
DMS_TSS_1h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_1h/DMS_TSS_1h_hyper.RDS")
DMS_TSS_4h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_4h/DMS_TSS_4h_hyper.RDS")
DMS_TSS_24h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_24h/DMS_TSS_24h_hyper.RDS")
DMS_TSS_72h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_72h/DMS_TSS_72h_hyper.RDS")
...
#DMR_TSS_all_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_all/DMR_TSS_all_hyper.RDS")
DMR_TSS_05h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_05h/DMR_TSS_05h_hyper.RDS")
DMR_TSS_1h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_1h/DMR_TSS_1h_hyper.RDS")
DMR_TSS_4h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_4h/DMR_TSS_4h_hyper.RDS")
DMR_TSS_24h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_24h/DMR_TSS_24h_hyper.RDS")
DMR_TSS_72h_hyper <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_72h/DMR_TSS_72h_hyper.RDS")
...
#DMS_TSS_all_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_all/DMS_TSS_all_hypo.RDS")
DMS_TSS_05h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_05h/DMS_TSS_05h_hypo.RDS")
DMS_TSS_1h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_1h/DMS_TSS_1h_hypo.RDS")
DMS_TSS_4h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_4h/DMS_TSS_4h_hypo.RDS")
DMS_TSS_24h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_24h/DMS_TSS_24h_hypo.RDS")
DMS_TSS_72h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_72h/DMS_TSS_72h_hypo.RDS")
...
#DMR_TSS_all_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_all/DMR_TSS_all_hypo.RDS")
DMR_TSS_05h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_05h/DMR_TSS_05h_hypo.RDS")
DMR_TSS_1h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_1h/DMR_TSS_1h_hypo.RDS")
DMR_TSS_4h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_4h/DMR_TSS_4h_hypo.RDS")
DMR_TSS_24h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_24h/DMR_TSS_24h_hypo.RDS")
DMR_TSS_72h_hypo <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_72h/DMR_TSS_72h_hypo.RDS")
...
#regions_anno_all <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_all/regions_anno_all.RDS")
regions_anno_05h <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_05h/regions_anno_05h.RDS")
regions_anno_1h <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_1h/regions_anno_1h.RDS")
regions_anno_4h <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_4h/regions_anno_4h.RDS")
regions_anno_24h <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_24h/regions_anno_24h.RDS")
regions_anno_72h <- readRDS("./shortTerm_exp/data/methylkit_res/anno_res_72h/regions_anno_72h.RDS")
...
DMR_05h_gostat_BP <- run.gostat(DMR_TSS_05h, regions_anno_05h, "BP")
DMR_1h_gostat_BP <- run.gostat(DMR_TSS_1h, regions_anno_1h, "BP")
DMR_4h_gostat_BP <- run.gostat(DMR_TSS_4h, regions_anno_4h, "BP")
DMR_24h_gostat_BP <- run.gostat(DMR_TSS_24h, regions_anno_24h, "BP")
DMR_72h_gostat_BP<- run.gostat(DMR_TSS_72h, regions_anno_72h, "BP")
...
DMR_05h_gostat_MF <- run.gostat(DMR_TSS_05h, regions_anno_05h, "MF")
DMR_1h_gostat_MF <- run.gostat(DMR_TSS_1h, regions_anno_1h, "MF")
DMR_4h_gostat_MF <- run.gostat(DMR_TSS_4h, regions_anno_4h, "MF")
DMR_24h_gostat_MF <- run.gostat(DMR_TSS_24h, regions_anno_24h, "MF")
DMR_72h_gostat_MF<- run.gostat(DMR_TSS_72h, regions_anno_72h, "MF")
...
DMR_05h_gostat_CC <- run.gostat(DMR_TSS_05h, regions_anno_05h, "CC")
DMR_1h_gostat_CC <- run.gostat(DMR_TSS_1h, regions_anno_1h, "CC")
DMR_4h_gostat_CC <- run.gostat(DMR_TSS_4h, regions_anno_4h, "CC")
DMR_24h_gostat_CC <- run.gostat(DMR_TSS_24h, regions_anno_24h, "CC")
DMR_72h_gostat_CC<- run.gostat(DMR_TSS_72h, regions_anno_72h, "CC")
...
#DMS_all_gostat_BP_hyper <- run.gostat(DMS_TSS_all_hyper, CpG_anno_all, "BP")
DMS_05h_gostat_BP_hyper <- run.gostat(DMS_TSS_05h_hyper, CpG_anno_05h, "BP")
DMS_1h_gostat_BP_hyper <- run.gostat(DMS_TSS_1h_hyper, CpG_anno_1h, "BP")
DMS_4h_gostat_BP_hyper <- run.gostat(DMS_TSS_4h_hyper, CpG_anno_4h, "BP")
DMS_24h_gostat_BP_hyper <- run.gostat(DMS_TSS_24h_hyper, CpG_anno_24h, "BP")
DMS_72h_gostat_BP_hyper <- run.gostat(DMS_TSS_72h_hyper, CpG_anno_72h, "BP")
...
#DMS_all_gostat_MF_hyper <- run.gostat(DMS_TSS_all_hyper, CpG_anno_all, "MF")
DMS_05h_gostat_MF_hyper <- run.gostat(DMS_TSS_05h_hyper, CpG_anno_05h, "MF")
DMS_1h_gostat_MF_hyper <- run.gostat(DMS_TSS_1h_hyper, CpG_anno_1h, "MF")
DMS_4h_gostat_MF_hyper <- run.gostat(DMS_TSS_4h_hyper, CpG_anno_4h, "MF")
DMS_24h_gostat_MF_hyper <- run.gostat(DMS_TSS_24h_hyper, CpG_anno_24h, "MF")
DMS_72h_gostat_MF_hyper<- run.gostat(DMS_TSS_72h_hyper, CpG_anno_72h, "MF")
...
#DMS_all_gostat_CC_hyper <- run.gostat(DMS_TSS_all_hyper, CpG_anno_all, "CC")
DMS_05h_gostat_CC_hyper <- run.gostat(DMS_TSS_05h_hyper, CpG_anno_05h, "CC")
DMS_1h_gostat_CC_hyper <- run.gostat(DMS_TSS_1h_hyper, CpG_anno_1h, "CC")
DMS_4h_gostat_CC_hyper <- run.gostat(DMS_TSS_4h_hyper, CpG_anno_4h, "CC")
DMS_24h_gostat_CC_hyper <- run.gostat(DMS_TSS_24h_hyper, CpG_anno_24h, "CC")
DMS_72h_gostat_CC_hyper<- run.gostat(DMS_TSS_72h_hyper, CpG_anno_72h, "CC")
...
#DMR_all_gostat_BP_hyper <- run.gostat(DMR_TSS_all_hyper, regions_anno_all, "BP")
DMR_05h_gostat_BP_hyper <- run.gostat(DMR_TSS_05h_hyper, regions_anno_05h, "BP")
DMR_1h_gostat_BP_hyper <- run.gostat(DMR_TSS_1h_hyper, regions_anno_1h, "BP")
DMR_4h_gostat_BP_hyper <- run.gostat(DMR_TSS_4h_hyper, regions_anno_4h, "BP")
DMR_24h_gostat_BP_hyper <- run.gostat(DMR_TSS_24h_hyper, regions_anno_24h, "BP")
DMR_72h_gostat_BP_hyper<- run.gostat(DMR_TSS_72h_hyper, regions_anno_72h, "BP")
...
#DMR_all_gostat_MF_hyper <- run.gostat(DMR_TSS_all_hyper, regions_anno_all, "MF")
DMR_05h_gostat_MF_hyper <- run.gostat(DMR_TSS_05h_hyper, regions_anno_05h, "MF")
DMR_1h_gostat_MF_hyper <- run.gostat(DMR_TSS_1h_hyper, regions_anno_1h, "MF")
DMR_4h_gostat_MF_hyper <- run.gostat(DMR_TSS_4h_hyper, regions_anno_4h, "MF")
DMR_24h_gostat_MF_hyper <- run.gostat(DMR_TSS_24h_hyper, regions_anno_24h, "MF")
DMR_72h_gostat_MF_hyper<- run.gostat(DMR_TSS_72h_hyper, regions_anno_72h, "MF")
...
#DMR_all_gostat_CC_hyper <- run.gostat(DMR_TSS_all_hyper, regions_anno_all, "CC")
DMR_05h_gostat_CC_hyper <- run.gostat(DMR_TSS_05h_hyper, regions_anno_05h, "CC")
DMR_1h_gostat_CC_hyper <- run.gostat(DMR_TSS_1h_hyper, regions_anno_1h, "CC")
DMR_4h_gostat_CC_hyper <- run.gostat(DMR_TSS_4h_hyper, regions_anno_4h, "CC")
DMR_24h_gostat_CC_hyper <- run.gostat(DMR_TSS_24h_hyper, regions_anno_24h, "CC")
DMR_72h_gostat_CC_hyper<- run.gostat(DMR_TSS_72h_hyper, regions_anno_72h, "CC")
...
#DMS_all_gostat_BP_hypo <- run.gostat(DMS_TSS_all_hypo, CpG_anno_all, "BP")
DMS_05h_gostat_BP_hypo <- run.gostat(DMS_TSS_05h_hypo, CpG_anno_05h, "BP")
DMS_1h_gostat_BP_hypo <- run.gostat(DMS_TSS_1h_hypo, CpG_anno_1h, "BP")
DMS_4h_gostat_BP_hypo <- run.gostat(DMS_TSS_4h_hypo, CpG_anno_4h, "BP")
DMS_24h_gostat_BP_hypo <- run.gostat(DMS_TSS_24h_hypo, CpG_anno_24h, "BP")
DMS_72h_gostat_BP_hypo <- run.gostat(DMS_TSS_72h_hypo, CpG_anno_72h, "BP")
...
#DMS_all_gostat_MF_hypo <- run.gostat(DMS_TSS_all_hypo, CpG_anno_all, "MF")
DMS_05h_gostat_MF_hypo <- run.gostat(DMS_TSS_05h_hypo, CpG_anno_05h, "MF")
DMS_1h_gostat_MF_hypo <- run.gostat(DMS_TSS_1h_hypo, CpG_anno_1h, "MF")
DMS_4h_gostat_MF_hypo <- run.gostat(DMS_TSS_4h_hypo, CpG_anno_4h, "MF")
DMS_24h_gostat_MF_hypo <- run.gostat(DMS_TSS_24h_hypo, CpG_anno_24h, "MF")
DMS_72h_gostat_MF_hypo<- run.gostat(DMS_TSS_72h_hypo, CpG_anno_72h, "MF")
...
#DMS_all_gostat_CC_hypo <- run.gostat(DMS_TSS_all_hypo, CpG_anno_all, "CC")
DMS_05h_gostat_CC_hypo <- run.gostat(DMS_TSS_05h_hypo, CpG_anno_05h, "CC")
DMS_1h_gostat_CC_hypo <- run.gostat(DMS_TSS_1h_hypo, CpG_anno_1h, "CC")
DMS_4h_gostat_CC_hypo <- run.gostat(DMS_TSS_4h_hypo, CpG_anno_4h, "CC")
DMS_24h_gostat_CC_hypo <- run.gostat(DMS_TSS_24h_hypo, CpG_anno_24h, "CC")
DMS_72h_gostat_CC_hypo<- run.gostat(DMS_TSS_72h_hypo, CpG_anno_72h, "CC")
...
#DMR_all_gostat_BP_hypo <- run.gostat(DMR_TSS_all_hypo, regions_anno_all, "BP")
DMR_05h_gostat_BP_hypo <- run.gostat(DMR_TSS_05h_hypo, regions_anno_05h, "BP")
DMR_1h_gostat_BP_hypo <- run.gostat(DMR_TSS_1h_hypo, regions_anno_1h, "BP")
DMR_4h_gostat_BP_hypo <- run.gostat(DMR_TSS_4h_hypo, regions_anno_4h, "BP")
DMR_24h_gostat_BP_hypo <- run.gostat(DMR_TSS_24h_hypo, regions_anno_24h, "BP")
DMR_72h_gostat_BP_hypo<- run.gostat(DMR_TSS_72h_hypo, regions_anno_72h, "BP")
...
#DMR_all_gostat_MF_hypo <- run.gostat(DMR_TSS_all_hypo, regions_anno_all, "MF")
DMR_05h_gostat_MF_hypo <- run.gostat(DMR_TSS_05h_hypo, regions_anno_05h, "MF")
DMR_1h_gostat_MF_hypo <- run.gostat(DMR_TSS_1h_hypo, regions_anno_1h, "MF")
DMR_4h_gostat_MF_hypo <- run.gostat(DMR_TSS_4h_hypo, regions_anno_4h, "MF")
DMR_24h_gostat_MF_hypo <- run.gostat(DMR_TSS_24h_hypo, regions_anno_24h, "MF")
DMR_72h_gostat_MF_hypo<- run.gostat(DMR_TSS_72h_hypo, regions_anno_72h, "MF")
...
#DMR_all_gostat_CC_hypo <- run.gostat(DMR_TSS_all_hypo, regions_anno_all, "CC")
DMR_05h_gostat_CC_hypo <- run.gostat(DMR_TSS_05h_hypo, regions_anno_05h, "CC")
DMR_1h_gostat_CC_hypo <- run.gostat(DMR_TSS_1h_hypo, regions_anno_1h, "CC")
DMR_4h_gostat_CC_hypo <- run.gostat(DMR_TSS_4h_hypo, regions_anno_4h, "CC")
DMR_24h_gostat_CC_hypo <- run.gostat(DMR_TSS_24h_hypo, regions_anno_24h, "CC")
DMR_72h_gostat_CC_hypo<- run.gostat(DMR_TSS_72h_hypo, regions_anno_72h, "CC")
...
#write.csv(DMR_all_gostat_BP, "./shortTerm_exp/data/go_res/DMR_all_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_BP, "./shortTerm_exp/data/go_res/DMR_05h_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_BP, "./shortTerm_exp/data/go_res/DMR_1h_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_BP, "./shortTerm_exp/data/go_res/DMR_4h_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_BP, "./shortTerm_exp/data/go_res/DMR_24h_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_BP, "./shortTerm_exp/data/go_res/DMR_72h_gostat_BP.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_BP, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_BP, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_BP, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_BP, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_BP, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_BP, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_BP.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_BP, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_BP, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_BP, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_BP, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_BP, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_BP.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_BP, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_BP.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_MF, "./shortTerm_exp/data/go_res/DMR_all_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_MF, "./shortTerm_exp/data/go_res/DMR_05h_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_MF, "./shortTerm_exp/data/go_res/DMR_1h_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_MF, "./shortTerm_exp/data/go_res/DMR_4h_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_MF, "./shortTerm_exp/data/go_res/DMR_24h_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_MF, "./shortTerm_exp/data/go_res/DMR_72h_gostat_MF.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_MF, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_MF, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_MF, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_MF, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_MF, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_MF, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_MF.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_MF, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_MF, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_MF, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_MF, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_MF, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_MF.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_MF, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_MF.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_CC, "./shortTerm_exp/data/go_res/DMR_all_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_CC, "./shortTerm_exp/data/go_res/DMR_05h_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_CC, "./shortTerm_exp/data/go_res/DMR_1h_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_CC, "./shortTerm_exp/data/go_res/DMR_4h_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_CC, "./shortTerm_exp/data/go_res/DMR_24h_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_CC, "./shortTerm_exp/data/go_res/DMR_72h_gostat_CC.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_CC, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_CC, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_CC, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_CC, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_CC, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_CC, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_CC.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_CC, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_CC, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_CC, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_CC.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_CC, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_CC.csv", row.names = FALSE)
...
write.csv(DMS_4h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_4h_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_24h_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_72h_gostat_BP_hyper.csv", row.names = FALSE)

write.csv(DMS_all_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_all_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_05h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_1h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_4h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_24h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_72h_fem_gostat_BP_hyper.csv", row.names = FALSE)

write.csv(DMS_all_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_all_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_05h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_1h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_4h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_24h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMS_72h_mal_gostat_BP_hyper.csv", row.names = FALSE)

#write.csv(DMS_all_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_all_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_05h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_1h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_4h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_24h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_72h_gostat_MF_hyper.csv", row.names = FALSE)

write.csv(DMS_all_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_all_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_05h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_1h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_4h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_24h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_72h_fem_gostat_MF_hyper.csv", row.names = FALSE)

write.csv(DMS_all_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_all_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_05h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_1h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_4h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_24h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMS_72h_mal_gostat_MF_hyper.csv", row.names = FALSE)

#write.csv(DMS_all_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_all_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_05h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_1h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_4h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_24h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_72h_gostat_CC_hyper.csv", row.names = FALSE)

write.csv(DMS_all_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_all_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_05h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_1h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_4h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_24h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_72h_fem_gostat_CC_hyper.csv", row.names = FALSE)

write.csv(DMS_all_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_all_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_05h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_05h_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_1h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_1h_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_4h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_4h_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_24h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_24h_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMS_72h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMS_72h_mal_gostat_CC_hyper.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_all_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_05h_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_1h_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_4h_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_24h_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_72h_gostat_BP_hyper.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_BP_hyper.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_BP_hyper, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_BP_hyper.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_all_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_05h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_1h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_4h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_24h_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_72h_gostat_MF_hyper.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_MF_hyper.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_MF_hyper, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_MF_hyper.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_all_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_05h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_1h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_4h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_24h_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_72h_gostat_CC_hyper.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_CC_hyper.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_CC_hyper.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_CC_hyper, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_CC_hyper.csv", row.names = FALSE)
...
write.csv(DMS_4h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_4h_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_24h_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_72h_gostat_BP_hypo.csv", row.names = FALSE)

write.csv(DMS_all_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_all_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_05h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_1h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_4h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_24h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_72h_fem_gostat_BP_hypo.csv", row.names = FALSE)

write.csv(DMS_all_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_all_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_05h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_1h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_4h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_24h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMS_72h_mal_gostat_BP_hypo.csv", row.names = FALSE)

#write.csv(DMS_all_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_all_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_05h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_1h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_4h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_24h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_72h_gostat_MF_hypo.csv", row.names = FALSE)

write.csv(DMS_all_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_all_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_05h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_1h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_4h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_24h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_72h_fem_gostat_MF_hypo.csv", row.names = FALSE)

write.csv(DMS_all_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_all_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_05h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_1h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_4h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_24h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMS_72h_mal_gostat_MF_hypo.csv", row.names = FALSE)

#write.csv(DMS_all_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_all_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_05h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_1h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_4h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_24h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_72h_gostat_CC_hypo.csv", row.names = FALSE)

write.csv(DMS_all_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_all_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_05h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_1h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_4h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_24h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_72h_fem_gostat_CC_hypo.csv", row.names = FALSE)

write.csv(DMS_all_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_all_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_05h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_05h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_1h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_1h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_4h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_4h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_24h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_24h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMS_72h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMS_72h_mal_gostat_CC_hypo.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_all_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_05h_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_1h_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_4h_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_24h_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_72h_gostat_BP_hypo.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_BP_hypo.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_BP_hypo, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_BP_hypo.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_all_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_05h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_1h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_4h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_24h_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_72h_gostat_MF_hypo.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_MF_hypo.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_MF_hypo, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_MF_hypo.csv", row.names = FALSE)

#write.csv(DMR_all_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_all_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_05h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_1h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_4h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_24h_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_72h_gostat_CC_hypo.csv", row.names = FALSE)

write.csv(DMR_all_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_all_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_05h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_1h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_4h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_24h_fem_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_fem_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_72h_fem_gostat_CC_hypo.csv", row.names = FALSE)

write.csv(DMR_all_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_all_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_05h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_05h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_1h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_1h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_4h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_4h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_24h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_24h_mal_gostat_CC_hypo.csv", row.names = FALSE)
write.csv(DMR_72h_mal_gostat_CC_hypo, "./shortTerm_exp/data/go_res/DMR_72h_mal_gostat_CC_hypo.csv", row.names = FALSE)
...
write.csv(DMS_fem_all_BP_hyper, "./shortTerm_exp/data/go_res/DMS_fem_combined_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_fem_all_MF_hyper, "./shortTerm_exp/data/go_res/DMS_fem_combined_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_fem_all_CC_hyper, "./shortTerm_exp/data/go_res/DMS_fem_combined_gostat_CC_hyper.csv", row.names = FALSE)
...
write.csv(DMS_mal_all_BP_hyper, "./shortTerm_exp/data/go_res/DMS_mal_combined_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMS_mal_all_MF_hyper, "./shortTerm_exp/data/go_res/DMS_mal_combined_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMS_mal_all_CC_hyper, "./shortTerm_exp/data/go_res/DMS_mal_combined_gostat_CC_hyper.csv", row.names = FALSE)
...
write.csv(DMR_fem_all_BP_hyper, "./shortTerm_exp/data/go_res/DMR_fem_combined_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_fem_all_MF_hyper, "./shortTerm_exp/data/go_res/DMR_fem_combined_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_fem_all_CC_hyper, "./shortTerm_exp/data/go_res/DMR_fem_combined_gostat_CC_hyper.csv", row.names = FALSE)
...
write.csv(DMR_mal_all_BP_hyper, "./shortTerm_exp/data/go_res/DMR_mal_combined_gostat_BP_hyper.csv", row.names = FALSE)
write.csv(DMR_mal_all_MF_hyper, "./shortTerm_exp/data/go_res/DMR_mal_combined_gostat_MF_hyper.csv", row.names = FALSE)
write.csv(DMR_mal_all_CC_hyper, "./shortTerm_exp/data/go_res/DMR_mal_combined_gostat_CC_hyper.csv", row.names = FALSE)
...
write.csv(DMS_fem_all_BP_hypo, "./shortTerm_exp/data/go_res/DMS_fem_combined_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_fem_all_MF_hypo, "./shortTerm_exp/data/go_res/DMS_fem_combined_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_fem_all_CC_hypo, "./shortTerm_exp/data/go_res/DMS_fem_combined_gostat_CC_hypo.csv", row.names = FALSE)
...
write.csv(DMS_mal_all_BP_hypo, "./shortTerm_exp/data/go_res/DMS_mal_combined_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMS_mal_all_MF_hypo, "./shortTerm_exp/data/go_res/DMS_mal_combined_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMS_mal_all_CC_hypo, "./shortTerm_exp/data/go_res/DMS_mal_combined_gostat_CC_hypo.csv", row.names = FALSE)
...
write.csv(DMR_fem_all_BP_hypo, "./shortTerm_exp/data/go_res/DMR_fem_combined_gostat_BP_hypo.csv", row.names = FALSE)
write.csv(DMR_fem_all_MF_hypo, "./shortTerm_exp/data/go_res/DMR_fem_combined_gostat_MF_hypo.csv", row.names = FALSE)
write.csv(DMR_fem_all_CC_hypo, "./shortTerm_exp/data/go_res/DMR_fem_combined_gostat_CC_hypo.csv", row.names = FALSE)
...
DMS.fem.MF <- plot.funct(DMS_05h_fem_gostat_MF_hyper, DMS_1h_fem_gostat_MF_hyper, DMS_4h_fem_gostat_MF_hyper, DMS_24h_fem_gostat_MF_hyper, DMS_72h_fem_gostat_MF_hyper,
                         nrow(DMS_TSS_05h_fem_hyper), nrow(DMS_TSS_1h_fem_hyper), nrow(DMS_TSS_4h_fem_hyper), nrow(DMS_TSS_24h_fem_hyper), nrow(DMS_TSS_72h_fem_hyper),
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMS_fem_goplot_MF_hyper.tiff")
...
DMR.fem.BP <- plot.funct(DMR_05h_fem_gostat_BP_hyper, DMR_1h_fem_gostat_BP_hyper, DMR_4h_fem_gostat_BP_hyper, DMR_24h_fem_gostat_BP_hyper, DMR_72h_fem_gostat_BP_hyper,
                         ...
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMR_fem_goplot_BP_hyper.tiff")
...
DMR.fem.MF <- plot.funct(DMR_05h_fem_gostat_MF_hyper, DMR_1h_fem_gostat_MF_hyper, DMR_4h_fem_gostat_MF_hyper, DMR_24h_fem_gostat_MF_hyper, DMR_72h_fem_gostat_MF_hyper,
                         nrow(DMR_TSS_05h_fem_hyper), nrow(DMR_TSS_1h_fem_hyper), nrow(DMR_TSS_4h_fem_hyper), nrow(DMR_TSS_24h_fem_hyper), nrow(DMR_TSS_72h_fem_hyper),
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMR_fem_goplot_MF_hyper.tiff")
...
DMS.mal.BP <- plot.funct(DMS_05h_mal_gostat_BP_hyper, DMS_1h_mal_gostat_BP_hyper, DMS_4h_mal_gostat_BP_hyper, DMS_24h_mal_gostat_BP_hyper, DMS_72h_mal_gostat_BP_hyper,
                         ...
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMS_mal_goplot_BP_hyper.tiff")
...
DMS.mal.MF <- plot.funct(DMS_05h_mal_gostat_MF_hyper, DMS_1h_mal_gostat_MF_hyper, DMS_4h_mal_gostat_MF_hyper, DMS_24h_mal_gostat_MF_hyper, DMS_72h_mal_gostat_MF_hyper,
                         nrow(DMS_TSS_05h_mal_hyper), nrow(DMS_TSS_1h_mal_hyper), nrow(DMS_TSS_4h_mal_hyper), nrow(DMS_TSS_24h_mal_hyper), nrow(DMS_TSS_72h_mal_hyper),
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMS_mal_goplot_MF_hyper.tiff")
...
DMR.mal.BP <- plot.funct(DMR_05h_mal_gostat_BP_hyper, DMR_1h_mal_gostat_BP_hyper, DMR_4h_mal_gostat_BP_hyper, DMR_24h_mal_gostat_BP_hyper, DMR_72h_mal_gostat_BP_hyper,
                         ...
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMR_mal_goplot_BP_hyper.tiff")
...
DMS.fem.MF <- plot.funct(DMS_05h_fem_gostat_MF_hypo, DMS_1h_fem_gostat_MF_hypo, DMS_4h_fem_gostat_MF_hypo, DMS_24h_fem_gostat_MF_hypo, DMS_72h_fem_gostat_MF_hypo,
                         nrow(DMS_TSS_05h_fem_hypo), nrow(DMS_TSS_1h_fem_hypo), nrow(DMS_TSS_4h_fem_hypo), nrow(DMS_TSS_24h_fem_hypo), nrow(DMS_TSS_72h_fem_hypo),
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMS_fem_goplot_MF_hypo.tiff")
...
DMR.fem.BP <- plot.funct(DMR_05h_fem_gostat_BP_hypo, DMR_1h_fem_gostat_BP_hypo, DMR_4h_fem_gostat_BP_hypo, DMR_24h_fem_gostat_BP_hypo, DMR_72h_fem_gostat_BP_hypo,
                         ...
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMR_fem_goplot_BP_hypo.tiff")
...
DMR.fem.MF <- plot.funct(DMR_05h_fem_gostat_MF_hypo, DMR_1h_fem_gostat_MF_hypo, DMR_4h_fem_gostat_MF_hypo, DMR_24h_fem_gostat_MF_hypo, DMR_72h_fem_gostat_MF_hypo,
                         nrow(DMR_TSS_05h_fem_hypo), nrow(DMR_TSS_1h_fem_hypo), nrow(DMR_TSS_4h_fem_hypo), nrow(DMR_TSS_24h_fem_hypo), nrow(DMR_TSS_72h_fem_hypo),
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMR_fem_goplot_MF_hypo.tiff")
...
DMS.mal.BP <- plot.funct(DMS_05h_mal_gostat_BP_hypo, DMS_1h_mal_gostat_BP_hypo, DMS_4h_mal_gostat_BP_hypo, DMS_24h_mal_gostat_BP_hypo, DMS_72h_mal_gostat_BP_hypo,
                         ...
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMS_mal_goplot_BP_hypo.tiff")
...
DMS.mal.MF <- plot.funct(DMS_05h_mal_gostat_MF_hypo, DMS_1h_mal_gostat_MF_hypo, DMS_4h_mal_gostat_MF_hypo, DMS_24h_mal_gostat_MF_hypo, DMS_72h_mal_gostat_MF_hypo,
                         nrow(DMS_TSS_05h_mal_hypo), nrow(DMS_TSS_1h_mal_hypo), nrow(DMS_TSS_4h_mal_hypo), nrow(DMS_TSS_24h_mal_hypo), nrow(DMS_TSS_72h_mal_hypo),
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMS_mal_goplot_MF_hypo.tiff")
...
DMR.mal.BP <- plot.funct(DMR_05h_mal_gostat_BP_hypo, DMR_1h_mal_gostat_BP_hypo, DMR_4h_mal_gostat_BP_hypo, DMR_24h_mal_gostat_BP_hypo, DMR_72h_mal_gostat_BP_hypo,
                         ...
                         "./shortTerm_exp/plots/finalized_tiff/go_plots/DMR_mal_goplot_BP_hypo.tiff")
...
#hyper
#gene.list.funct(DMS_TSS_all_hyper, "./shortTerm_exp/data/gene_lists/DMS_allTP_allSex_genelist.csv")
gene.list.funct(DMS_TSS_05h_hyper, "./shortTerm_exp/data/gene_lists/DMS_05h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_1h_hyper,  "./shortTerm_exp/data/gene_lists/DMS_1h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_4h_hyper,  "./shortTerm_exp/data/gene_lists/DMS_4h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_24h_hyper,  "./shortTerm_exp/data/gene_lists/DMS_24h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_72h_hyper,  "./shortTerm_exp/data/gene_lists/DMS_72h_allSex_genelist.csv")

gene.list.funct(DMS_TSS_all_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMS_allTP_fem_genelist.csv")
gene.list.funct(DMS_TSS_05h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMS_05h_fem_genelist.csv")
gene.list.funct(DMS_TSS_1h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMS_1h_fem_genelist.csv")
gene.list.funct(DMS_TSS_4h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMS_4h_fem_genelist.csv")
gene.list.funct(DMS_TSS_24h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMS_24h_fem_genelist.csv")
gene.list.funct(DMS_TSS_72h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMS_72h_fem_genelist.csv")

gene.list.funct(DMS_TSS_all_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMS_allTP_mal_genelist.csv")
gene.list.funct(DMS_TSS_05h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMS_05h_mal_genelist.csv")
gene.list.funct(DMS_TSS_1h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMS_1h_mal_genelist.csv")
gene.list.funct(DMS_TSS_4h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMS_4h_mal_genelist.csv")
gene.list.funct(DMS_TSS_24h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMS_24h_mal_genelist.csv")
gene.list.funct(DMS_TSS_72h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMS_72h_mal_genelist.csv")

#gene.list.funct(DMR_TSS_all_hyper,  "./shortTerm_exp/data/gene_lists/DMR_allTP_allSex_genelist.csv")
gene.list.funct(DMR_TSS_05h_hyper,  "./shortTerm_exp/data/gene_lists/DMR_05h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_1h_hyper,  "./shortTerm_exp/data/gene_lists/DMR_1h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_4h_hyper,  "./shortTerm_exp/data/gene_lists/DMR_4h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_24h_hyper,  "./shortTerm_exp/data/gene_lists/DMR_24h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_72h_hyper,  "./shortTerm_exp/data/gene_lists/DMR_72h_allSex_genelist.csv")

gene.list.funct(DMR_TSS_all_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMR_allTP_fem_genelist.csv")
gene.list.funct(DMR_TSS_05h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMR_05h_fem_genelist.csv")
gene.list.funct(DMR_TSS_1h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMR_1h_fem_genelist.csv")
gene.list.funct(DMR_TSS_4h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMR_4h_fem_genelist.csv")
gene.list.funct(DMR_TSS_24h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMR_24h_fem_genelist.csv")
gene.list.funct(DMR_TSS_72h_fem_hyper,  "./shortTerm_exp/data/gene_lists/DMR_72h_fem_genelist.csv")

gene.list.funct(DMR_TSS_all_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMR_allTP_mal_genelist.csv")
gene.list.funct(DMR_TSS_05h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMR_05h_mal_genelist.csv")
gene.list.funct(DMR_TSS_1h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMR_1h_mal_genelist.csv")
gene.list.funct(DMR_TSS_4h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMR_4h_mal_genelist.csv")
gene.list.funct(DMR_TSS_24h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMR_24h_mal_genelist.csv")
gene.list.funct(DMR_TSS_72h_mal_hyper,  "./shortTerm_exp/data/gene_lists/DMR_72h_mal_genelist.csv")

#hypo
#gene.list.funct(DMS_TSS_all_hypo, "./shortTerm_exp/data/gene_lists/DMS_allTP_allSex_genelist.csv")
gene.list.funct(DMS_TSS_05h_hypo, "./shortTerm_exp/data/gene_lists/DMS_05h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_1h_hypo,  "./shortTerm_exp/data/gene_lists/DMS_1h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_4h_hypo,  "./shortTerm_exp/data/gene_lists/DMS_4h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_24h_hypo,  "./shortTerm_exp/data/gene_lists/DMS_24h_allSex_genelist.csv")
gene.list.funct(DMS_TSS_72h_hypo,  "./shortTerm_exp/data/gene_lists/DMS_72h_allSex_genelist.csv")

gene.list.funct(DMS_TSS_all_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMS_allTP_fem_genelist.csv")
gene.list.funct(DMS_TSS_05h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMS_05h_fem_genelist.csv")
gene.list.funct(DMS_TSS_1h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMS_1h_fem_genelist.csv")
gene.list.funct(DMS_TSS_4h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMS_4h_fem_genelist.csv")
gene.list.funct(DMS_TSS_24h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMS_24h_fem_genelist.csv")
gene.list.funct(DMS_TSS_72h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMS_72h_fem_genelist.csv")

gene.list.funct(DMS_TSS_all_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMS_allTP_mal_genelist.csv")
gene.list.funct(DMS_TSS_05h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMS_05h_mal_genelist.csv")
gene.list.funct(DMS_TSS_1h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMS_1h_mal_genelist.csv")
gene.list.funct(DMS_TSS_4h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMS_4h_mal_genelist.csv")
gene.list.funct(DMS_TSS_24h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMS_24h_mal_genelist.csv")
gene.list.funct(DMS_TSS_72h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMS_72h_mal_genelist.csv")

#gene.list.funct(DMR_TSS_all_hypo,  "./shortTerm_exp/data/gene_lists/DMR_allTP_allSex_genelist.csv")
gene.list.funct(DMR_TSS_05h_hypo,  "./shortTerm_exp/data/gene_lists/DMR_05h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_1h_hypo,  "./shortTerm_exp/data/gene_lists/DMR_1h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_4h_hypo,  "./shortTerm_exp/data/gene_lists/DMR_4h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_24h_hypo,  "./shortTerm_exp/data/gene_lists/DMR_24h_allSex_genelist.csv")
gene.list.funct(DMR_TSS_72h_hypo,  "./shortTerm_exp/data/gene_lists/DMR_72h_allSex_genelist.csv")

gene.list.funct(DMR_TSS_all_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMR_allTP_fem_genelist.csv")
gene.list.funct(DMR_TSS_05h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMR_05h_fem_genelist.csv")
gene.list.funct(DMR_TSS_1h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMR_1h_fem_genelist.csv")
gene.list.funct(DMR_TSS_4h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMR_4h_fem_genelist.csv")
gene.list.funct(DMR_TSS_24h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMR_24h_fem_genelist.csv")
gene.list.funct(DMR_TSS_72h_fem_hypo,  "./shortTerm_exp/data/gene_lists/DMR_72h_fem_genelist.csv")

gene.list.funct(DMR_TSS_all_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMR_allTP_mal_genelist.csv")
gene.list.funct(DMR_TSS_05h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMR_05h_mal_genelist.csv")
gene.list.funct(DMR_TSS_1h_mal_hypo,  "./shortTerm_exp/data/gene_lists/DMR_1h_mal_genelist.csv")
