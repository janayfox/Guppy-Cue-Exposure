...
DMS.diffmeth.05h <- readRDS("./05h/DMS_res/DMSdiffmeth_05h_5X.RDS")
DMS.diffmeth.1h <- readRDS("./1h/DMS_res/DMSdiffmeth_1h_5X.RDS")
DMS.diffmeth.4h <- readRDS("./4h/DMS_res/DMSdiffmeth_4h_5X.RDS")
DMS.diffmeth.24h <- readRDS("./24h/DMS_res/DMSdiffmeth_24h_5X.RDS")
DMS.diffmeth.72h <- readRDS("./72h/DMS_res/DMSdiffmeth_72h_5X.RDS")
DMS.diffmeth.all <- readRDS("./all/DMS_res/DMSdiffmeth_all_5X.RDS")

DMS.diffmeth.05h.fem <- readRDS("./05h/DMS_res/DMSdiffmeth_05h_fem_5X.RDS")
DMS.diffmeth.1h.fem <- readRDS("./1h/DMS_res/DMSdiffmeth_1h_fem_5X.RDS")
DMS.diffmeth.4h.fem <- readRDS("./4h/DMS_res/DMSdiffmeth_4h_fem_5X.RDS")
DMS.diffmeth.24h.fem <- readRDS("./24h/DMS_res/DMSdiffmeth_24h_fem_5X.RDS")
DMS.diffmeth.72h.fem <- readRDS("./72h/DMS_res/DMSdiffmeth_72h_fem_5X.RDS")
DMS.diffmeth.all.fem <- readRDS("./all/DMS_res/DMSdiffmeth_all_fem_5X.RDS")

DMS.diffmeth.05h.mal <- readRDS("./05h/DMS_res/DMSdiffmeth_05h_mal_5X.RDS")
DMS.diffmeth.1h.mal <- readRDS("./1h/DMS_res/DMSdiffmeth_1h_mal_5X.RDS")
DMS.diffmeth.4h.mal <- readRDS("./4h/DMS_res/DMSdiffmeth_4h_mal_5X.RDS")
DMS.diffmeth.24h.mal <- readRDS("./24h/DMS_res/DMSdiffmeth_24h_mal_5X.RDS")
DMS.diffmeth.72h.mal <- readRDS("./72h/DMS_res/DMSdiffmeth_72h_mal_5X.RDS")
DMS.diffmeth.all.mal <- readRDS("./all/DMS_res/DMSdiffmeth_all_mal_5X.RDS")

CpG.05h <- readRDS("./05h/DMS_res/DMSmydiff_05h_5X.RDS")
CpG.1h <- readRDS("./1h/DMS_res/DMSmydiff_1h_5X.RDS")
CpG.4h <- readRDS("./4h/DMS_res/DMSmydiff_4h_5X.RDS")
CpG.24h <- readRDS("./24h/DMS_res/DMSmydiff_24h_5X.RDS")
CpG.72h <- readRDS("./72h/DMS_res/DMSmydiff_72h_5X.RDS")
CpG.all <- readRDS("./all/DMS_res/DMSmydiff_all_5X.RDS")

CpG.05h.fem <- readRDS("./05h/DMS_res/DMSmydiff_05h_fem_5X.RDS")
CpG.1h.fem <- readRDS("./1h/DMS_res/DMSmydiff_1h_fem_5X.RDS")
CpG.4h.fem <- readRDS("./4h/DMS_res/DMSmydiff_4h_fem_5X.RDS")
CpG.24h.fem <- readRDS("./24h/DMS_res/DMSmydiff_24h_fem_5X.RDS")
CpG.72h.fem <- readRDS("./72h/DMS_res/DMSmydiff_72h_fem_5X.RDS")
CpG.all.fem <- readRDS("./all/DMS_res/DMSmydiff_all_fem_5X.RDS")

CpG.05h.mal <- readRDS("./05h/DMS_res/DMSmydiff_05h_mal_5X.RDS")
CpG.1h.mal <- readRDS("./1h/DMS_res/DMSmydiff_1h_mal_5X.RDS")
CpG.4h.mal <- readRDS("./4h/DMS_res/DMSmydiff_4h_mal_5X.RDS")
CpG.24h.mal <- readRDS("./24h/DMS_res/DMSmydiff_24h_mal_5X.RDS")
CpG.72h.mal <- readRDS("./72h/DMS_res/DMSmydiff_72h_mal_5X.RDS")
CpG.all.mal <- readRDS("./all/DMS_res/DMSmydiff_all_mal_5X.RDS")
