...
#read in data files
cue.data <- read_csv(here("gup_cue_exp", "data", "raw", "cueresponse.csv"))
cue.tank.data <- read_csv(here("gup_cue_exp", "data", "raw", "cuetanks.csv"))
...
#export data 
write_csv(fivemin.cue.data, file(here("gup_cue_exp", "data", "clean", "clean_cue_fivemin.csv")))
write_csv(twomin.cue.data, file(here("gup_cue_exp", "data", "clean", "clean_cue_twomin.csv")))
