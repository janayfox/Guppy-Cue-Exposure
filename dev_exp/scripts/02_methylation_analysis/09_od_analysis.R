#######################################################
### Goal: Plot and analyze overdispersion results
### Author: Janay Fox
### R script
#######################################################
...
#read data 
DMS_diffmeth_fem <- readRDS("./dev_exp/data/methylkit_res_od/DMSdiffmeth_fem_5X_data.RDS")
DMS_diffmeth_mal <- readRDS("./dev_exp/data/methylkit_res_od/DMSdiffmeth_mal_5X_data.RDS")

DMR_diffmeth_fem <- readRDS("./dev_exp/data/methylkit_res_od/DMRdiffmeth_fem_5X_data.RDS")
DMR_diffmeth_mal <- readRDS("./dev_exp/data/methylkit_res_od/DMRdiffmeth_mal_5X_data.RDS")
